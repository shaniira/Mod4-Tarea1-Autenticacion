...
import com.andinaseguros.application.service.cliente.*;
import com.andinaseguros.application.service.vehiculo.*;
...
public class ClienteController {
    ...
    ResponseEntity<ClienteResponse> crear(@Valid @RequestBody CrearClienteRequest solicitud) {
        return ResponseEntity.status(201).body(crearClienteUseCase.execute(toApplication(solicitud)));
    }
        ...
        return ResponseEntity.status(201)
                .body(
                        crearVehiculo.execute(
                                new com.andinaseguros.application.dto.CrearVehiculoDto(
                                        id,
                                        solicitud.placa(),
                                        solicitud.marca(),
                                        solicitud.modelo(),
