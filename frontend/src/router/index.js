...
const routes = [{ path: '/login', component: () => import('@/views/LoginView.vue'), meta: { public: true } }, { path: '/', component: () => import('@/layouts/AppLayout.vue'), children: [{ path: '', redirect: () => landingFor(useAuthStore()) }, { path: 'mi-cuenta', component: () => import('@/views/MiCuentaView.vue'), meta: { roles: ['CLIENTE'] } }, { path: 'dashboard', component: () => import('@/views/DashboardView.vue'), meta: { roles: ['ADMIN', 'ACTUARIO', 'AGENTE'] } }, { path: 'clientes', component: () => import('@/views/ClientesView.vue'), meta: { roles: ['ADMIN', 'AGENTE'] } }, { path: 'tarifas', component: () => import('@/views/TarifasView.vue'), meta: { roles: ['ADMIN', 'ACTUARIO'] } }, { path: 'cotizaciones', component: () => import('@/views/CotizacionesView.vue'), meta: { roles: ['ADMIN', 'AGENTE'] } }, { path: 'polizas', component: () => import('@/views/PolizasView.vue'), meta: { roles: ['ADMIN', 'AGENTE'] } }, { path: 'renovaciones', component: () => import('@/views/RenovacionesView.vue'), meta: { roles: ['ADMIN', 'AGENTE'] } }] }];
